...
export const sendVotes = createAsyncThunk(
    ...
    async({votes, categoryEndpoint}, {rejectWithValue, dispatch}) => {
        try {
...
export const { addCategory, addVote, setCategories, clearMessages, setGraduatesSubmitTrue, setGeneralSubmitTrue, setUndergraduatesSubmitTrue } = categorySlice.actions;
